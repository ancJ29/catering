export default {
  ...
  "Are you sure you want to update supplier?": "Bạn có chắc chắn muốn cập nhật nhà cung cấp?",
  "Remove material": "Xoá nguyên liệu",
  "Are you sure you want to remove material?": "Bạn có chắc chắn muốn xoá nguyên liệu?",
  ...
  "Return to purchase order coordination": "Quay lại danh sách điều phối nguồn cung",
