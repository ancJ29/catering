...
const MemoPopover = ({ purchaseOrder, users }: MemoPopoverProps) => {
    ...
    >
      ...
      <Popover.Dropdown style={{ pointerEvents: "none" }}>
        ...
        <CustomText
          title={t("Create by")}
          content={
            users.get(purchaseOrder.others.createdById)?.fullName
          }
        />
        <CustomText
          title={t("Create at")}
          content={formatTime(
            purchaseOrder.others.createAt,
            "DD/MM/YYYY HH:mm",
          )}
        />
        <CustomText
          title={t("Approved by")}
          content={
            users.get(purchaseOrder.others.approvedById)?.fullName
          }
        />
        <CustomText
          title={t("Approved at")}
          content={formatTime(
            purchaseOrder.others.approvedAt,
            "DD/MM/YYYY HH:mm",
          )}
        />
      </Popover.Dropdown>
